		...
		<dl>
			...
			<dd id=user_main>
				<ul>
					...
					<li class=user_main_r><input class=ibtnentercssclass style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" onclick="submit()" type=image src="${pageContext.request.contextPath }/images/admin/user_botton.gif">
					</li>
				</ul>
			<dd id=user_bottom>
				<ul>
